...
public class DriveToTag extends Command {
    ...
    private double distanceToTarget = -123;
    ...
    public void initialize() {
        ...
        if (!SmartDashboard.containsKey("TargetDistance_Inches")) {
            SmartDashboard.putNumber("TargetDistance_Inches", 30.0); // Default 30 inches
        }
    }
    ...
    public void execute() {
        ...
        double targetDistanceInches = SmartDashboard.getNumber("TargetDistance_Inches", 30.0);
